                ...
                <div class="centrar">
                    <div class="centrartabla">
                        ...
                        <form action=" controlador" method="post">
                            <input type="hidden" name="todo" value="asignajornalero">
                            <div id="tablasinsert" style="
                                ...
                                <div style="margin: 5px;">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody> 
                                            <%
                                                ClasesBD.JornaleroBD.cargarJornalero();

                                                for (int i = 0; i < ClasesBD.JornaleroBD.jornaleroSize(); i++) {

                                                    out.println("<tr>");
                                                    out.println("<td>" + ClasesBD.JornaleroBD.sacarNombre(ClasesBD.JornaleroBD.idjornalero(i)) + "</td>");
                                                    out.println("<td><input type='radio' name='idjornalero' value=" + ClasesBD.JornaleroBD.idjornalero(i) + "></td>");
                                                    out.println("</tr>");
                                        ...
                                        <tbody> 
                                            <%                                                int iduser = ClasesBD.UsuarioBD.idUser(user);
                                                ...
                                                for (int i = 0; i < ClasesBD.PropietarioBD.parcelasSize(); i++) {
                                                    ...
                                                    out.println("<td><input type='radio' name='idparcela' value=" + ClasesBD.PropietarioBD.getId(i) + "></td>");
                                                    out.println("</tr>");
