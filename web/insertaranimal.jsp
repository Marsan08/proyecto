                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody> 
                                            <%                        ClasesBD.EGanaderaBD.cargarEGanadera();
                                                ...
                                                for (int i = 0; i < ClasesBD.EGanaderaBD.EGanaderaSize(); i++) {
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody> 
                                            <tr>
                                                ...
                                                <td><input type="number" min="0" name="crotal" id="crotal"/></td>
                                    ...
                                    <tbody> 
                                        <%
                                            ...
                                            for (int i = 0; i < ClasesBD.JornaleroBD.parcelasGanaderasSize(); i++) {
                                                ...
                                                int idpganadera = ClasesBD.JornaleroBD.sacarIdParcelaDeGanadera(idjornalero);
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody> 
                                        <tr>
                                            ...
                                            <td><input type="text" name="crotal"id="crotal"/></td>
