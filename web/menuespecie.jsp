        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" >
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="menuespecie.jsp">Especies</a></li>
                ...
                <div class="centrar">
                    <div class="centrartabla">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody> 
                                <%
                                    ClasesBD.EspecieBD.cargarEspecie();
                                    for (int i = 0; i < ClasesBD.EspecieBD.EspeciesSize(); i++) {
                                        int idtipo = ClasesBD.EspecieBD.getTipo(i);

                                        out.println("<tr>");
                                        out.println("<td>" + ClasesBD.EspecieBD.getIdnombre(i) + "</td>");
                                        out.println("<td>" + ClasesBD.TipoBD.getNombre(idtipo) + "</td>");
                                        out.println("<td><form action='controlador' method='post'><input type='hidden' value='ejecutarbespecie' name='todo'><input type='hidden' value=" + ClasesBD.EspecieBD.getId(i) + " name='idespecie'><input type='submit' value='Borrar' class='boton'></form></td>");
                                        out.println("</tr>");
                                    }
                                %>
                            </tbody>
