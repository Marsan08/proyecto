    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" >
            <div class="container-fluid">
                ...
                <ul <ul class="salir" style="float: right; margin: 10px; ">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody> 
                                                <%
                                                    ...
                                                    int iduser = ClasesBD.UsuarioBD.idUser(user);
                                                    int idjor = ClasesBD.JornaleroBD.idJornalero(iduser);
                                                    ClasesBD.JornaleroBD.cargarParcelas(idjor);

                                                    for (int i = 0; i < ClasesBD.JornaleroBD.parcelasSize(); i++) {

                                                        int idprop = ClasesBD.JornaleroBD.getPropietarioParcela(ClasesBD.JornaleroBD.getId(i));
