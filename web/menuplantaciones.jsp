                                ...
                                <tbody> 
                                    <%
                                        ...
                                        for (int i = 0; i < ClasesBD.PlantacionBD.PlantacionSize(); i++) {
                                            ...
                                            Date frecogida = ClasesBD.PlantacionBD.sacarFRecogida(i);
                                            
                                            //out.println("la fecha es "  + ClasesBD.PlantacionBD.sacarFRecogida(i));
                                            ...
                                            /*if(frecogida == null){
                                                ...
                                                out.println("<td class='frecogida' value="+ ClasesBD.PlantacionBD.getFRecogida(i) +"><p class='ocultar'>" + ClasesBD.PlantacionBD.getFRecogida(i) + "</p></td>");
