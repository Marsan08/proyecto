                                ...
                                <tbody> 
                                    <%
                                        ...
                                        for (int i = 0; i < ClasesBD.UsuarioBD.UsuariosSize(); i++) {
                                            ...
                                            out.println("<td><form action='controlador' method='post'><input type='hidden' value='modificarcontra' name='todo'><input type='hidden' name='idusuario' value=" + ClasesBD.UsuarioBD.idusuario(i) + "><input type='submit' name='modificarcontra' value='Modificar contraseña' class='boton'></form></td>");
